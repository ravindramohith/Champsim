...
//             invalidate_data(block[set][way].address);
//         }
...
// uint8_t CACHE::invalidate_data(uint64_t address)
// {
//     uint8_t upper_level_dirty = 0;
    
//     if (upper_level_icache[cpu]) {
//         upper_level_dirty = ((CACHE *)upper_level_icache[cpu])->invalidate_data(address);

//         if (upper_level_dcache[cpu] != upper_level_icache[cpu]) {
//             upper_level_dirty = ((CACHE *)upper_level_dcache[cpu])->invalidate_data(address);
//         }
//     }
